...
package io.openk9.plugins.database.enrichprocessor;
...
public class AsyncDatabaseNerEnrichProcessor implements AsyncEnrichProcessor {
    @Override
    ...
    @Override
    public String name() {
        return AsyncDatabaseNerEnrichProcessor.class.getName();
    }
}
